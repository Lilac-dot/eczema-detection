"""Same as extract_color_features_curated.py but for the merged manifest_curated_v2.csv."""
import csv
...
MANIFEST = ROOT / "manifest_curated_v2.csv"
OUT_CSV = ROOT / "color_features_curated_v2.csv"
RESIZE_TO = (128, 128)
