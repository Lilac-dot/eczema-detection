"""Evaluate the improved (partially fine-tuned) curated CNN on its held-out test split."""
import csv
...
MODEL_PATH = Path(r"C:\Users\tishy\Documents\Honors\models\curated_resnet18_v2.pt")
IMG_SIZE = 224
