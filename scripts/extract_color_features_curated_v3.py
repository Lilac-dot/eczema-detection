"""Same as extract_color_features_curated.py but for the 50/50 manifest_curated_v3.csv."""
import csv
...
MANIFEST = ROOT / "manifest_curated_v3.csv"
OUT_CSV = ROOT / "color_features_curated_v3.csv"
RESIZE_TO = (128, 128)
