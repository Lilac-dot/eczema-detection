"""Same as train_curated_lightgbm.py but on the merged manifest_curated_v2 dataset."""
import csv
...
FEATURES_CSV = ROOT / "color_features_curated_v2.csv"
...
def load_split(split_name, by_path):
    manifest = ROOT / f"manifest_curated_v2_{split_name}.csv"
    X, y = [], []
...
def main():
    ...
    model.save_model(str(Path(r"C:\Users\tishy\Documents\Honors\models\curated_lightgbm_v2.txt")))
    print("\nModel saved to models/curated_lightgbm_v2.txt")
