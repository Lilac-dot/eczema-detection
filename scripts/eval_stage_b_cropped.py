"""Evaluate the cropped-image Stage B model on its held-out test split."""
import csv
...
MODEL_PATH = Path(r"C:\Users\tishy\Documents\Honors\models\stage_b_resnet18_cropped.pt")
...
def main():
    ...
    test_ds = EczemaDataset(ROOT / "manifest_cropped_test.csv", eval_tf)
